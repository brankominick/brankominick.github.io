      ...
      <section id="content">
        ...
        <Container
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            <Card
            title="ESP32C6 Graphics"
            excerpt="A program for the ESP32C6 that cycles through GIFs, images, and function graphs. A fun holiday gift!"
            path=""
            slug=""
            img=""
            />
            ...
            excerpt="ESP-32 + MQTT-fed Grafana dashboard to track and visualize plant conditions."
            path=""
            slug=""
            img=""
            />
            ...
            excerpt="Desktop application built in Java Swing for simulating eCommerce workflows, including shopping cart and inventory management."
            path=""
            slug=""
            img=""
            />
            <Card
            title="Canine Performance Tracking App (Coming Soon!)"
            excerpt="Cross-platform mobile application using React Native to address a pain point for competitive dog handlers."
            path=""
            slug=""
            img=""
            />
