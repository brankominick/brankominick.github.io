        ...
        */}
        ...
        {ctaText && (
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="/#projects" className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-medium transition">
              {ctaText}
            </a>
            <a
              href="https://github.com/brankominick"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700/80 hover:bg-gray-600 text-white px-6 py-3 rounded-xl font-medium transition border border-gray-500/50"
            >
              GitHub
            </a>
          </div>
