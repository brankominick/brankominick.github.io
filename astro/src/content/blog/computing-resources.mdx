...
import gpt3Water from '../../assets/images/computing-resources/gpt3WaterFootprint.png';
import memory from '../../assets/images/computing-resources/Memory-Hierarchy-Design.png';
...
![GPT-3 Water Consumption Footprint]({gpt3Water} "GPT-3 Water Consumption Footprint")[^1]
...
![Memory Hierarchy Diagram]({memory} "Memory Hierarchy Diagram")[^8]
