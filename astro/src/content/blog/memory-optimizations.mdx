...
import before from "../../assets/images/computing-resources/before.png"
import after from "../../assets/images/computing-resources/after.png"
...
![Before Fusion]({before} "Before Fusion")
...
![After Fusion]({after} "After Fusion")
...
<GradientCheckpointChart client:load />
